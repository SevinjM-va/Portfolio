  ...
  return(
    <section className="sections" id="section-3">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader' >Wild & Wacky Vegetables</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Landing Page</h3>
            <p class="project1p">
            This is a static website where you can retrieve information. I utilized Bootstrap, HTML, and CSS for its design.
            </p>
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Coloring Game</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>ROBOFRIENDS</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Currency Converter</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Pokedex App</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Form Container</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Memory Game</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Snap Shot</h3>
            <p class="project1p">
      ...
      <div class="project">
        ...
        <div className='detail'>
          <h3 className='detailsheader'>Meme Generator</h3>
            <p class="project1p">
